...
class VideoMultiScaleMaskedTransformerDecoder_advisor(VideoMultiScaleMaskedTransformerDecoder):
...
@TRANSFORMER_DECODER_REGISTRY.register()
class VideoMultiScaleMaskedTransformerDecoder_minvis(VideoMultiScaleMaskedTransformerDecoder_advisor):
