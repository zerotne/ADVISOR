...
from .datasets.ytvis import COCO_TO_YTVIS_2019, COCO_TO_YTVIS_2021, COCO_TO_YTVIS_2023, COCO_TO_OVIS
    ...
    def __init__(
        ...
        *,
        ...
        if not is_tgt:
            ...
            # elif tgt_dataset_name.startswith("ytvis_2023"):
            #     src2tgt = COCO_TO_YTVIS_2021
            elif tgt_dataset_name.startswith("ytvis_2023"):
                src2tgt = COCO_TO_YTVIS_2023
            elif tgt_dataset_name.startswith("ovis"):
