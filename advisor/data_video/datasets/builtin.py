...
from .ytvis import (
    ...
    _get_ytvis_2023_instances_meta,
...
# ==== Predefined splits for YTVIS 2023 ===========
_PREDEFINED_SPLITS_YTVIS_2023 = {
    "ytvis_2023_train": ("ytvis_2023/train/JPEGImages",
                         "ytvis_2023/train.json"),
    "ytvis_2023_val": ("ytvis_2023/valid/JPEGImages",
                       "ytvis_2023/valid.json"),
    "ytvis_2023_test": ("ytvis_2023/test/JPEGImages",
                        "ytvis_20213test.json"),
}
...
_PREDEFINED_SPLITS_COCO_VIDEO = {
    ...
    "coco2ytvis2023_train": ("coco/train2017", "coco/annotations/coco2ytvis2023_train.json"),
    "coco2ytvis2023_val": ("coco/val2017", "coco/annotations/coco2ytvis2023_val.json"),
...
def register_all_ytvis_2023(root):
    for key, (image_root, json_file) in _PREDEFINED_SPLITS_YTVIS_2023.items():
        # Assume pre-defined datasets live in `./datasets`.
        register_ytvis_instances(
            key,
            _get_ytvis_2021_instances_meta(),
