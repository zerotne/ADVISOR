...
convert_list = [
    ...
    (COCO_TO_YTVIS_2023, 
        os.path.join(_root, "coco/annotations/instances_train2017.json"),
        os.path.join(_root, "coco/annotations/coco2ytvis2023_train.json"), "COCO to YTVIS 2023:"),
    (COCO_TO_YTVIS_2023, 
        os.path.join(_root, "coco/annotations/instances_val2017.json"),
        os.path.join(_root, "coco/annotations/coco2ytvis2023_val.json"), "COCO val to YTVIS 2023:"),
    (COCO_TO_OVIS, 
        os.path.join(_root, "coco/annotations/instances_train2017.json"),
